    ...
    <div class="max-w-full mx-auto">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
            ...
            <div class="bg-white p-6 rounded-xl shadow-lg border-l-4 border-green-500">
                ...
                <p class="text-2xl font-extrabold text-gray-800 mt-1">5</p>
                <a href="#" class="text-xs text-green-600 mt-2 hover:underline font-semibold">View All</a>
            </div>

            <!-- Pending Booking Requests Card -->
            <div class="bg-white p-6 rounded-xl shadow-lg border-l-4 border-yellow-500">
                <p class="text-sm font-medium text-gray-500 uppercase">Pending Requests</p>
                <p class="text-2xl font-extrabold text-gray-800 mt-1">2</p>
                <a href="#" class="text-xs text-yellow-600 mt-2 hover:underline font-semibold">Review Now</a>
            </div>

            <!-- Occupied Properties Card -->
            <div class="bg-white p-6 rounded-xl shadow-lg border-l-4 border-blue-500">
                <p class="text-sm font-medium text-gray-500 uppercase">Occupied Properties</p>
                <p class="text-2xl font-extrabold text-gray-800 mt-1">3</p>
                <a href="#" class="text-xs text-blue-600 mt-2 hover:underline font-semibold">View Details</a>
            </div>
        </div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div class="lg:col-span-2 bg-white p-6 rounded-xl shadow-lg">
                <div class="flex justify-between items-center mb-4">
                    <h2 class="text-lg font-semibold text-gray-700">Pending Booking Requests</h2>
                    <a href="#" class="text-sm text-green-600 hover:text-green-800">View All Requests</a>
                </div>
                    ...
                    <table class="min-w-full divide-y divide-gray-200">
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            ...
                            <tr>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">Cozy Downtown Studio</td>
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">Oct 1, 2024</td>
                            ...
                            <tr>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">Modern City Apartment</td>
